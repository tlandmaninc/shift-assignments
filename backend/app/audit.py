...
class AuditAction:
    ...
    SHIFT_TYPE_CREATE = "SHIFT_TYPE_CREATE"
    SHIFT_TYPE_UPDATE = "SHIFT_TYPE_UPDATE"
    SHIFT_TYPE_DELETE = "SHIFT_TYPE_DELETE"
    CROSS_CONSTRAINT_CREATE = "CROSS_CONSTRAINT_CREATE"
    CROSS_CONSTRAINT_DELETE = "CROSS_CONSTRAINT_DELETE"
    CHAT_TOOL_EXECUTED = "CHAT_TOOL_EXECUTED"
