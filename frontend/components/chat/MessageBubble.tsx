...
export function MessageBubble({ message }: MessageBubbleProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'max-w-[90%] sm:max-w-[80%] p-3 sm:p-4 rounded-2xl overflow-hidden break-words',
          isUser
